 ...
 * @author GRIP
 */
public abstract class TestingPipeline extends Subsystem  {
	...
	public void process(Mat source0) {
		...
		double[] hsvThresholdHue = { 72.842, 95.15};
		double[] hsvThresholdSaturation = { 82.554, 255.0 };
		double[] hsvThresholdValue = { 64.21, 255.0 };
